...
>
> **v1.0 positioning:** "The reactive data grid that extends the cluster into the browser."
...
|------------|-------------|
| **Distributed Maps** | Partitioned key-value store (LWW-Map, OR-Map) with automatic CRDT conflict resolution |
...
|---------|-------|-------------------|--------|
| **v1.0** | Working IMDG | Distributed maps, clustering, live queries, search, PostgreSQL, admin UI | In progress (5/7 services done) |
| **v2.0** | Data Platform | DataFusion SQL, DAG streaming, schemas, shapes, connectors, WASM | After v1.0 |
| **v3.0** | Enterprise | Multi-tenancy, S3 tiered storage, vector search, bi-temporal queries | After v2.0 |
