    ...
    <section id="coming-from" className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="text-center mb-16">
        ...
        <p className="text-neutral-600 dark:text-neutral-300">
          Migrating from another sync stack? Each guide names what TopGun does not replace, up
          front.
        </p>
      </div>
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-card-border">
              <th className="py-3 px-4 text-sm font-mono text-neutral-500 uppercase tracking-wider">
                Coming from
              </th>
              <th className="py-3 px-4 text-sm font-mono text-neutral-500 uppercase tracking-wider">
                Why migrate
          ...
          <tbody>
            ...
            <tr className="border-b border-card-border">
              ...
              <td className="py-3 px-4 text-sm text-foreground">
                <a href="/docs/guides/migrating-from-yjs" className="text-brand hover:underline">
                  Guide
                </a>
              </td>
              <td className="py-3 px-4 text-sm text-foreground">Live</td>
