    ...
    <div className="bg-neutral-50 dark:bg-neutral-800/50 rounded-xl p-6 font-mono text-sm">
      <div className="space-y-3">
        ...
        <div className="flex items-start gap-4">
          ...
          <span className="text-neutral-400">→</span>
          <span>
            <code className="bg-neutral-200 dark:bg-neutral-700 px-1 rounded">AUTH</code> + JWT
            token
          </span>
        </div>
        <div className="flex items-start gap-4">
        ...
        <div className="flex items-start gap-4">
          ...
          <span className="text-neutral-400">→</span>
          <span>
            <code className="bg-neutral-200 dark:bg-neutral-700 px-1 rounded">AUTH_ACK</code>{' '}
            (success) or close connection (failure)
          </span>
        </div>
      </div>
    </div>
