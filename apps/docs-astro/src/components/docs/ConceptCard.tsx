    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          <h3
            className={`text-xl font-semibold text-foreground mb-2 ${colors.hoverText} transition-colors`}
          >
            {title}
          </h3>
          <p className="text-neutral-600 dark:text-neutral-300 mb-4">{description}</p>
          <div
            className={`flex items-center gap-2 text-sm font-medium ${colors.linkText} opacity-0 group-hover:opacity-100 transition-opacity`}
          >
            <span>Read more</span>
