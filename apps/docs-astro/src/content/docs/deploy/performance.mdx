...
<div className="bg-neutral-50 dark:bg-neutral-900/50 border border-card-border rounded-xl p-6 my-6 not-prose">
  ...
  <div className="grid md:grid-cols-3 gap-6">
    ...
    <div>
      <div className="text-3xl font-bold text-green-600 dark:text-green-400">560,000+</div>
  ...
  <p className="text-xs text-neutral-500 mt-4">
    Benchmarks measured 2026-03-27 on M1 Max using the in-process load harness (<code>cargo bench --bench load_harness</code>, 200 connections, 30s). Fire-and-wait measures round-trip to ACK; fire-and-forget measures raw push throughput. Run <code>cargo bench --bench load_harness</code> to reproduce on your hardware.
  </p>
</div>
