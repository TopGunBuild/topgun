...
export const serverConfigCode = `# Development: use the test-server binary (included in repo)
...
<div className="not-prose">
  <CodeBlock title="terminal" language="bash" code={serverConfigCode} />
</div>
