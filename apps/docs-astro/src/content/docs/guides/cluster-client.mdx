...
<div className="not-prose">
  <CodeBlock language="typescript" code={`import { TopGunClient, IDBAdapter } from '@topgunbuild/client';
...
<div className="not-prose">
  <CodeBlock language="typescript" code={`cluster: {
  seeds: [
...
<div className="not-prose">
  <CodeBlock language="typescript" code={`// Your code doesn't need to handle failover explicitly
const users = client.getMap('users');
...
<div className="not-prose">
  <CodeBlock language="typescript" code={`// Listen for connection state changes
...
<div className="not-prose">
  <CodeBlock language="typescript" code={`// Monitor synchronization progress
...
<div className="not-prose">
  <CodeBlock language="typescript" code={`// src/lib/topgun.ts
...
<div className="not-prose">
  <CodeBlock language="typescript" code={`// src/app/providers.tsx
