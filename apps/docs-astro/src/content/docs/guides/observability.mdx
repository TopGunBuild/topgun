...
<AlertBox variant="warning" title="Partially Implemented" text="Some metric names and config options on this page reference the old Node.js server. The Rust server uses different metric names and tracing configuration." />
