...
<AlertBox variant="warning" title="Partially Implemented" text="Some tuning knobs and config options on this page do not exist in the current Rust server. Benchmark numbers may not reflect actual performance." />

export const highThroughputConfig = `# High throughput configuration
...
# For advanced tuning, see: /docs/reference/server`;

export const lowLatencyConfig = `# Low latency configuration
...
# For latency tuning details, see: /docs/reference/server`;

export const productionConfig = `# Balanced production configuration
PORT=8080 \\
DATABASE_URL=postgres://user:pass@localhost/topgun \\
...
<div className="not-prose">
  <CodeBlock title="High Throughput Configuration" language="bash" code={highThroughputConfig} />
</div>
...
<div className="not-prose">
  <CodeBlock title="Low Latency Configuration" language="bash" code={lowLatencyConfig} />
</div>
...
<div className="not-prose">
  <CodeBlock title="Production Configuration" language="bash" code={productionConfig} />
</div>
...
<div className="grid md:grid-cols-3 gap-4 my-6 not-prose">
  ...
  <div className="p-4 border border-brand-subtle/20 bg-brand-subtle/10 rounded-lg">
    <h4 className="font-semibold text-brand mb-2">Balanced</h4>
