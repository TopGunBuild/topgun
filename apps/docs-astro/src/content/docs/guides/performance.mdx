...
export const highThroughputConfig = `import { ServerFactory } from '@topgunbuild/server';
...
export const lowLatencyConfig = `import { ServerFactory } from '@topgunbuild/server';
...
export const productionConfig = `import { ServerFactory } from '@topgunbuild/server';
