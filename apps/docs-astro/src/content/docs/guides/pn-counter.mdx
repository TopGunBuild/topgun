...
<div className="grid md:grid-cols-3 gap-4 my-6 not-prose">
  <div className="p-4 bg-brand-subtle/10 rounded-lg border border-brand-subtle/20">
    <Cloud className="w-6 h-6 text-brand-subtle mb-2" />
    <h3 className="font-semibold text-brand">Real-time Sync</h3>
    <p className="text-sm text-brand">Changes sync automatically between all connected clients</p>
  </div>
