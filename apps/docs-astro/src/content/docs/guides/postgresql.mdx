...
export const tablesCode = `-- TopGun automatically creates these tables on startup
...
CREATE TABLE IF NOT EXISTS topgun_merkle (
  map_name     TEXT   NOT NULL,
  partition_id INTEGER NOT NULL,
  tree_data    BYTEA  NOT NULL,
  PRIMARY KEY (map_name, partition_id)
);`;
...
<div className="grid md:grid-cols-2 gap-4 my-6 not-prose">
  ...
  <div className="p-4 border border-card-border rounded-lg">
    ...
    <ul className="text-sm text-neutral-600 dark:text-neutral-300 space-y-1">
      <li>topgun_maps, topgun_merkle</li>
