...
<div className="bg-brand-subtle/10 border border-brand-subtle/20 rounded-xl p-6 my-6 not-prose">
  ...
  <span className="text-brand">For the full Rust server configuration including the <code className="px-1.5 py-0.5 rounded bg-brand-subtle/10 text-sm">PostgresDataStore</code> API, see the <a href="/docs/reference/server" className="underline">Server API reference</a>.</span>
</div>
