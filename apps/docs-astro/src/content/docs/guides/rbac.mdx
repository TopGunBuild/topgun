...
<div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl p-5 mb-8 not-prose">
  ...
  <ul className="text-sm text-amber-800 dark:text-amber-200 space-y-1 list-disc list-inside">
    ...
    <li><strong>Works today:</strong> Default-allow — <code>MapPermissions::default()</code> is <code>&#123; read: true, write: true &#125;</code> and <code>require_auth</code> defaults to <code>false</code>. All maps are accessible without authentication by default.</li>
    <li><strong>To enable deny-by-default:</strong> Configure <code>SecurityConfig</code> with <code>require_auth: true</code> and <code>default_permissions: MapPermissions &#123; read: false, write: false &#125;</code>.</li>
...
<div className="bg-brand-subtle/10 border border-brand-subtle/20 rounded-lg p-4 mb-12 flex items-start gap-3 not-prose">
  ...
  <div>
    <h3 className="font-semibold text-brand mb-1">Development-Friendly Defaults</h3>
    <p className="text-sm text-brand">
      TopGun Server allows all access by default (<code>read: true, write: true</code>, <code>require_auth: false</code>). To enable deny-by-default, configure <code>SecurityConfig</code> with <code>require_auth: true</code> and <code>default_permissions: &#123; read: false, write: false &#125;</code>.
    </p>
  </div>
</div>
