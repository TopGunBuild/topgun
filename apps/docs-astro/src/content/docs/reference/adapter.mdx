...
<div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 rounded-xl p-4 mb-4 not-prose">
  <span className="text-blue-700 dark:text-blue-400"><strong>Note:</strong> PostgreSQL storage is handled by the <strong>Rust server</strong> (<code className="px-1.5 py-0.5 rounded bg-blue-100 dark:bg-blue-800/50 text-sm">PostgresDataStore</code>), not a client adapter. Configure via <code className="px-1.5 py-0.5 rounded bg-blue-100 dark:bg-blue-800/50 text-sm">DATABASE_URL</code> environment variable. See the <a href="/docs/reference/server" className="underline">Server API reference</a> for details.</span>
</div>
