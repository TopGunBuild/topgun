...
<div className="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 p-4 my-6 not-prose">
  <p className="text-sm text-blue-800 dark:text-blue-200">
    <strong>Server-side Feature:</strong> Full-text search must be enabled on the server for the target map with <code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">fullTextSearch</code> configuration.
