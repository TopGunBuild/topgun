...
describe("StandingQueryIndex Performance", () => {
  ...
  describe("Live query callback overhead", () => {
    ...
    // With 1 callback — callbackCount tracks invocations for benchmark introspection;
    // the value is not asserted but the increment itself exercises the callback path.
    ...
    // With 10 callbacks — same pattern as callbackCount1 above.
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    ...
    // With 100 callbacks — same pattern as callbackCount1 above.
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
