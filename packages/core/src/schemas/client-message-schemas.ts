...
export type ServerBatchEventMessage = z.infer<
  typeof ServerBatchEventMessageSchema
>;
...
export type SyncResetRequiredPayload = z.infer<
  typeof SyncResetRequiredPayloadSchema
>;
...
export type SyncResetRequiredMessage = z.infer<
  typeof SyncResetRequiredMessageSchema
>;

// --- Payload Types from Existing Sync Schemas ---

export type SyncRespRootPayload = z.infer<
  typeof SyncRespRootMessageSchema
>["payload"];
export type SyncRespBucketsPayload = z.infer<
  typeof SyncRespBucketsMessageSchema
>["payload"];
export type SyncRespLeafPayload = z.infer<
  typeof SyncRespLeafMessageSchema
>["payload"];

export type ORMapSyncRespRootPayload = z.infer<
  typeof ORMapSyncRespRootSchema
>["payload"];
export type ORMapSyncRespBucketsPayload = z.infer<
  typeof ORMapSyncRespBucketsSchema
>["payload"];
export type ORMapSyncRespLeafPayload = z.infer<
  typeof ORMapSyncRespLeafSchema
>["payload"];
export type ORMapDiffResponsePayload = z.infer<
  typeof ORMapDiffResponseSchema
>["payload"];
