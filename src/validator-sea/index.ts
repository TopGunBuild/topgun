...
import {
    ...
    initAjv as ajvBaseInit, createValidator as createBaseValidator
} from '../validator';
...
export const read = (data: any, key: string, pair: boolean|string = false) =>
{
...
const validateSeaProperty = (ajv: any) => (
    schema: any,
    data: any,
    pSchema: any,
    _cPath: any,
...
{
    const soul: string = parentData && parentData['_'] && parentData['_']['#'] || '';

    if (keyInParent === '_')
    {
        return true;
    }
    const obj              = seaSoulRoute.match(soul) || seaAuthorRoute.match(soul) || {};
...
export const createValidator = (): {schema: any, validate: ValidateFunction<any>} =>
{
