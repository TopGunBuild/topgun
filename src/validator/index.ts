        ...
        const pathOrRef = (p: string[]) => 
{
            ...
            const refName: string | false =
                refRouteParams && refRouteParams['refName'];
            ...
            TopGunMsg: {
                ...
                properties: {
                    '#': {
                        ...
                        description:
                            'This should be a globally unique identifier',
                        type: 'string',
                    },
                    '##': {
                    ...
                    '@': {
                        title: 'Responding To',
                        description:
                            'The message identifier this message is responding to',
                        type: 'string',
                    },
                    '><': {
                    ...
                    'how': {
                        ...
                        description:
                            'Shouldn\'t actually be sent over wire (but it is)',
                        type: 'string',
                    },
                    'mesh': {
                        title: '??',
                    ...
                    'user': {
                        title: '??',
                        description:
                            'I don\'t think this is supposed to be sent over wire',
                    },
                    'err': {
